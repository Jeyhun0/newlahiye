...
class ProductExportController extends Controller
{
    ...
    public function create()
    {
        ...
        $end_date = Date("Y-m-d");
        $filename =  $end_date . "-cü il tarixinə müqavilələrin icra vəziyyəti";
        return (new \App\Exports\Products\ProductExport($data))->download($filename . '.xlsx', \Maatwebsite\Excel\Excel::XLSX);
    }
