...
class ProductSheet3Export implements FromView, ShouldAutoSize, WithEvents, WithTitle
{
    protected $data;
    ...
    {
        return view('products.exports.multi.index3', [
            'items' => $this->data
        ]);
    }
    ...
    {
        return 'icrası bitmiş'; // Burada istədiyiniz adı yazın
    }
}
