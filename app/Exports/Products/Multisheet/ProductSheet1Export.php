...
class ProductSheet1Export implements FromView, ShouldAutoSize, WithEvents, WithTitle
{
    protected $data;
    ...
    {
        return view('products.exports.multi.index1', [
            'items' => $this->data
        ]);
    }
    ...
    {
        return '27.12.2024'; // Burada istədiyiniz adı yazın
    }
}
